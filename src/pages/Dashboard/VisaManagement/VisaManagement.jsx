          ...
          {selectedRecord && (
            <div className="space-y-2">
              ...
              <p className="flex gap-1 flex-wrap">
                ...
                <p className="text-normal-desc">{selectedRecord.dob}</p>
              </p>
              <p className="flex gap-1 flex-wrap">
                <strong>Sex:</strong>
                <p className="text-normal-desc">{selectedRecord.sex}</p>
              </p>
              <p className="flex gap-1 flex-wrap">
              ...
              <p className="flex gap-1 flex-wrap">
                ...
                <p className="text-normal-desc">
                  {selectedRecord.validityStart} - {selectedRecord.validityEnd}
                </p>
              </p>
              <p className="flex gap-1 flex-wrap">
